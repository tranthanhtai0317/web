	...
	class Loader{
		...
		public function __construct(){
			...
			if($this->url['controller'] == ""){
				$this->controllerFileName = "homecontroller";
				$this->controllerClassName = "HomeController";
			}else{
				$this->controllerFileName = strtolower($this->url['controller'])."controller";//ex. chuyển name thành name(chuyển chữ hoa thành chữ thường)
